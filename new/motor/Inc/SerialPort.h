...
public:
    ...
    void resetSerial(size_t recvLength = 78,
        ...
        stopbits_t stopbits = stopbits_t::stopbits_one,
        flowcontrol_t flowcontrol = flowcontrol_t::flowcontrol_none) {}
    size_t send(uint8_t* sendMsg, size_t sendLength) { return 0; }
    size_t recv(uint8_t* recvMsg) { return 0; }
    bool sendRecv(uint8_t* sendMsg, uint8_t* recvMsg, size_t sendLength) { return false; }
    bool sendRecv(MOTOR_send* sendMsg, MOTOR_recv* recvMsg) { return false; }
    bool sendRecv(std::vector<MOTOR_send>& sendVec, std::vector<MOTOR_recv>& recvVec) { return false; }
